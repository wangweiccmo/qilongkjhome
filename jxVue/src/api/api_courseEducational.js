...
const upStatus = `${HOST}/${table}/upStatus`;
...
const tableType = {
    ...
    teachingMethods: {type:'String',label:'授课方式',iType:'input',rules:'required,max-255'},
    testType:{type: 'String',label:'考试形式',width:100,iType:'input',rules:'required,max-255',br:true},
